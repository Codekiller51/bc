        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link to="/how-it-works" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                How It Works
              </Link>
              <Link to="/testimonials" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                Testimonials
              </Link>
              <Link to="/pricing" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                Pricing
              </Link>
            </nav>
          </div>
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2 text-sm text-gray-500 dark:text-gray-400">
              <Link to="/register/creative" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                Join as a Creative
              </Link>
              <Link to="/success-stories" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                Success Stories
              </Link>
              <Link to="/resources" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                Resources
              </Link>
              <Link to="/faq" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                FAQ
              </Link>
            </nav>
          </div>
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link to="/careers" className="hover:text-emerald-600 dark:hover:text-emerald-400">
                Careers
              </Link>
